...
import 'package:juvis2/common/title.dart';
...
class _LineChart1State extends State<LineChart1> {
  ...
  FlTitlesData get titlesData1 => FlTitlesData(
        bottomTitles: AxisTitles(
          sideTitles: bottomTitles, //x축 표시선
        ),
  ...
  LineChartBarData get lineChartBarData1_1 => LineChartBarData(
        isCurved: true, //완만선 vs 꺾은선
        color: const Color(0xff4af699), //그래프 색상
        barWidth: 8, //그래프선의 굵기
        // isStrokeCapRound: true,
        dotData: FlDotData(show: true), //그래프 선 위 도트여부
